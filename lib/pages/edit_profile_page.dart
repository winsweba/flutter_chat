...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  TextEditingController profiletionTextEditingController = TextEditingController();
  ...
  getAndDisplayUserInformation() async{
    ...
    profiletionTextEditingController.text = user.profileName;
  ...
  updateUserData(){
    setState(() {
      profiletionTextEditingController.text.trim().length < 3 || profiletionTextEditingController.text.isEmpty ? _profileNameValid = false : _profileNameValid = true;
    ...
    if(_bioValid && _profileNameValid){
      usersReference.document(widget.currentOnlineUserId).updateData({
        "profileName": profiletionTextEditingController.text,
      ...
      children: <Widget>[
        Padding(
          ...
          TextField(
            ...
            controller: profiletionTextEditingController,
